    ...
    : QCtmWindow(parent)
{
    ...
    connect(m_path1, &QCtmPathBrowser::pathClicked, this, [=](const QString& path)
        {
            QCtmMessageBox::information(this, tr("Path Clicked"), path);
        });
    connect(m_path1, &QCtmPathBrowser::pathChanged, this, [=](const QString& path)
        {
            QCtmMessageBox::information(this, tr("Path Changed"), path);
        });
    connect(m_path2, &QCtmPathBrowser::pathClicked, this, [=](const QString& path)
        {
            QCtmMessageBox::information(this, tr("Path Clicked"), path);
        });
    connect(m_path2, &QCtmPathBrowser::pathChanged, this, [=](const QString& path)
        {
            QCtmMessageBox::information(this, tr("Path Changed"), path);
        });
}
